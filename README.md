...
I’m a Full Stack Developer focused on building scalable, high-performance web applications using **TypeScript, Node.js, Next.js**, and modern tooling.  
I work across backend, frontend, DevOps, and AI integrations - creating clean APIs, reliable systems, and user-focused digital products.

My experience spans:
- Full-stack development with Node.js, Express, tRPC  
- LLM & AI integrations
- API development, external services, and automations  
- Databases including both SQL & NoSQL solutions  
- Deployment with Docker, GCP, Vercel, and DigitalOcean  

I enjoy solving complex problems, optimizing systems, and delivering products that bring real value.

---

## 🔭 Current Focus

- AI agent integrations (Voiceflow, Vapi, LLM pipelines)
- Building modular full-stack features with **Next.js + TypeScript**
